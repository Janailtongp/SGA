                    ...
                    <form class="form-group" action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <select class="form-control select2" name="inquilino" style="width: 100%;"  required >
                                ...
                                if (isset($_GET['id_inquilino'])) {
                                    ...
                                    $conn = F_conect();
                                    $result = mysqli_query($conn, "Select * from iquilino where id_usuario=" . $_SESSION['idUSU'] . " and id=" . $id_inquilino);
                        ...
                        <div class="form-group">
                            <select class="form-control select2" name="propriedade" style="width: 100%;"  required >
                                ...
                                if (isset($_GET['id_propriedade'])) {
                                    ...
                                    $result = mysqli_query($conn, "Select * from propriedade where id_proprietario=" . $_SESSION['idUSU'] . " and id=" . $id_propriedade);
                                    if (mysqli_num_rows($result) >= 1) {
                                        while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" id="datepicker" name="data_vencimento" placeholder="Data de Inicio"  data-inputmask="'alias': 'dd/mm/yyyy'" data-mask required>
                            </div>
                            <!-- /.input group -->
                        </div> 
                        <div class="form-group">
